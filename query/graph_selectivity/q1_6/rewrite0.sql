...
drop view if exists orderView8736314845590169203 cascade;
drop view if exists minView3564053510705471904 cascade;
drop view if exists joinView4252133862165458202 cascade;
drop view if exists g1 cascade;
drop view if exists orderView1508666079840230255 cascade;
drop view if exists minView5719364849888902338 cascade;
drop view if exists joinView1719917380055875343 cascade;
drop view if exists sample1907860021593006797 cascade;
drop view if exists maxRn5868011465254616856 cascade;
drop view if exists target2021639317442213828 cascade;
drop view if exists end5171086560027768210 cascade;
drop view if exists sample4667287415919343808 cascade;
drop view if exists maxRn9077866189149192680 cascade;
drop view if exists target1380727735188710689 cascade;
drop view if exists end3145558741005453759 cascade;
...
create or replace view joinView1719917380055875343 as select v1, v2, v8, mfR2875800549036126768 from g1 join minView5719364849888902338 using(v2) where v8+800<mfR2875800549036126768;
...
create or replace view end5171086560027768210 as select v1, v8, v4, v2, mfR3068473505922860898 from joinView1719917380055875343 join target2021639317442213828 using(v2) where v8+800<mfR3068473505922860898;
create or replace view sample4667287415919343808 as select * from orderView8736314845590169203 where rn % 5 = 1;
create or replace view maxRn9077866189149192680 as select v4, max(rn) as mrn from end5171086560027768210 join sample4667287415919343808 using(v4) where v8+800<v10 group by v4;
...
create or replace view end3145558741005453759 as select v1, v8, v6, v4, v2, v10 from end5171086560027768210 join target1380727735188710689 using(v4) where v8+800<v10;
