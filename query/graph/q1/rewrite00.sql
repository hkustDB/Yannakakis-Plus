...
create or replace view c2 as select src, count(*) as cnt from Graph group by src;
create or replace view f1 as select g1.*, cnt as c1cnt from Graph g1 join c1 using(src);
create or replace view f2 as select g3.*, cnt as c2cnt from Graph g3 join c2 on g3.dst=c2.src;
