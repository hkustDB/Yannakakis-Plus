...
create or replace view semiJoinView2912078581772148908 as select v1, v6 from bag5Aux70 where (v1, v6) in (select v1, v6 from bag5);
...
select sum(distinct v1+v6+v8) from end4968659657995716154;
