create or replace view bag5 as select g1.src as v1, g1.dst as v2, g2.dst as v4, g3.dst as v6 from Graph as g1, Graph as g2, Graph as g3 where g1.dst=g2.src and g2.dst=g3.src;
create or replace view bag5Aux70 as select v1, v6 from bag5;
create or replace view semiJoinView6260526784937944882 as select v1, v6 from bag5Aux70 where (v1, v6) in (select v1, v6 from bag5);
...
select sum(distinct v1+v6+v8) from end3285087383674126193;
