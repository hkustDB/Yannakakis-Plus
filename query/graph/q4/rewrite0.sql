...
drop view if exists g3Aux5 cascade;
drop view if exists g1 cascade;
drop view if exists minView7939951884320969217 cascade;
drop view if exists joinView4459027404603699962 cascade;
drop view if exists minView1865589155647858021 cascade;
drop view if exists joinView8023837617662965704 cascade;
