...
drop view if exists semiJoinView914723926835382282 cascade;
drop view if exists g1 cascade;
drop view if exists semiJoinView7427663282224900031 cascade;
drop view if exists semiEnum4510279466163969869 cascade;
drop view if exists semiEnum6245865409982678183 cascade;
...
CREATE OR REPLACE VIEW semiJoinView7427663282224900031 AS 
SELECT v7, v2, v8 
FROM g1 
WHERE EXISTS (
    SELECT 1 
    FROM semiJoinView914723926835382282 
    WHERE g1.v2 = semiJoinView914723926835382282.v2
);
