...
create temp table aggView3901782608565113684 as select v6, (v8 + v6) as v10 from semiDown3112978590336153533;
...
create temp table aggView1163172505283237893 as select v2 from semiDown418234138208069801;
create temp table aggJoin6032898181978070521 as select v2, v4, v2 from semiUp4904060637412190459 join aggView1163172505283237893 using(v2);
create temp table aggView6027738833723581910 as select v4, SUM(v10) as v10, COUNT(*) as annot from aggJoin2284114773209983867 group by v4,v10;
create temp table aggJoin1496120660622947326 as select v2, v4, v2, v10 from aggJoin6032898181978070521 join aggView6027738833723581910 using(v4);
select v2,v4,v10 from aggJoin1496120660622947326;
