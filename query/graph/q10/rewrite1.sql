...
create or replace view sample2577815196885956067 as select * from orderView6080150369944812713 where rn % 500 = 1;
...
create or replace view target4596271331944359685 as select v4, v6, mfR7281057556794608409 from orderView6080150369944812713 join maxRn7030922833561544727 using(v4) where rn < mrn + 500;
create or replace view end4962970722515786128 as select distinct v6, v9, v2, v1, mfR7281057556794608409 from joinView8389344330646010843 join target4596271331944359685 using(v4) where v1<mfR7281057556794608409;
create or replace view sample3782132636759783025 as select * from orderView6884453833669215682 where rn % 500 = 1;
...
create or replace view target5766552921961154457 as select v6, v8 from orderView6884453833669215682 join maxRn7747925014547052708 using(v6) where rn < mrn + 500;
create or replace view end6164703090339578381 as select v9, v2, v8 from end4962970722515786128 join target5766552921961154457 using(v6) where v1<v8;
