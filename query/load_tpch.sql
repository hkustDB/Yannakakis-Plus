...
COPY NATION FROM '/home/bchenba/TPC-H/100G/nation.tbl' ( DELIMITER '|' );

CREATE TABLE REGION  ( R_REGIONKEY  INTEGER NOT NULL,
                            R_NAME       CHAR(25) NOT NULL,
                            R_COMMENT    VARCHAR(152));
COPY REGION FROM '/home/bchenba/TPC-H/100G/region.tbl' ( DELIMITER '|' );
...
COPY PART FROM '/home/bchenba/TPC-H/100G/part.tbl' ( DELIMITER '|' );
...
COPY SUPPLIER FROM '/home/bchenba/TPC-H/100G/supplier.tbl' ( DELIMITER '|' );
...
COPY PARTSUPP FROM '/home/bchenba/TPC-H/100G/partsupp.tbl' ( DELIMITER '|' );
...
COPY CUSTOMER FROM '/home/bchenba/TPC-H/100G/customer.tbl' ( DELIMITER '|' );
...
COPY ORDERS FROM '/home/bchenba/TPC-H/100G/orders.tbl' ( DELIMITER '|' );
