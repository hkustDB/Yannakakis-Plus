...
COPY NATION FROM '/home/bchenba/TPC-H/500G/nation.tbl' ( DELIMITER '|' );

drop table if exists region;
CREATE TABLE REGION  ( R_REGIONKEY  INTEGER NOT NULL,
                            R_NAME       CHAR(25) NOT NULL,
                            R_COMMENT    VARCHAR(152));
COPY REGION FROM '/home/bchenba/TPC-H/500G/region.tbl' ( DELIMITER '|' );
...
COPY PART FROM '/home/bchenba/TPC-H/500G/part.tbl' ( DELIMITER '|' );
...
COPY SUPPLIER FROM '/home/bchenba/TPC-H/500G/supplier.tbl' ( DELIMITER '|' );
...
COPY PARTSUPP FROM '/home/bchenba/TPC-H/500G/partsupp.tbl' ( DELIMITER '|' );
...
COPY CUSTOMER FROM '/home/bchenba/TPC-H/500G/customer.tbl' ( DELIMITER '|' );
...
COPY ORDERS FROM '/home/bchenba/TPC-H/500G/orders/orders.tbl.*' ( DELIMITER '|' );
...
COPY LINEITEM FROM '/home/bchenba/TPC-H/500G/lineitem/lineitem.tbl.*' ( DELIMITER '|' );
