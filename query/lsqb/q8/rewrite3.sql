create or replace view aggView6836862070779618756 as select CommentId as v3, TagId as v8 from Comment_hasTag_Tag as cht2;
create or replace view aggJoin840865714475174188 as select ParentMessageId as v1, v8 from Comment_replyOf_Message as Comment_replyOf_Message, aggView6836862070779618756 where Comment_replyOf_Message.CommentId=aggView6836862070779618756.v3;
create or replace view aggView2465956494877866071 as select v1, COUNT(*) as annot, v8 from aggJoin840865714475174188 group by v1,v8;
