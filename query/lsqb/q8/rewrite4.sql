create or replace view aggView4310104493668838678 as select CommentId as v3, TagId as v8 from Comment_hasTag_Tag as cht2;
create or replace view aggJoin2169174392551005200 as select ParentMessageId as v1, v8 from Comment_replyOf_Message as Comment_replyOf_Message, aggView4310104493668838678 where Comment_replyOf_Message.CommentId=aggView4310104493668838678.v3;
create or replace view aggView5618146487974932095 as select v1, COUNT(*) as annot, v8 from aggJoin2169174392551005200 group by v1,v8;
