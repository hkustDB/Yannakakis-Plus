create or replace view aggView183990511291475041 as select CommentId as v3, TagId as v8 from Comment_hasTag_Tag as cht2;
create or replace view aggJoin1335083672740583199 as select ParentMessageId as v1, v8 from Comment_replyOf_Message as Comment_replyOf_Message, aggView183990511291475041 where Comment_replyOf_Message.CommentId=aggView183990511291475041.v3;
...
create or replace view aggJoin4441526940712214286 as select v8, annot, v2 from aggJoin1335083672740583199 join aggView1195509769361662110 using(v1) where v2 < v8;
