...
create or replace view g2_2 as select src, dst from g2_1 where (src) in (select dst from Graph g1);
...
create or replace view g2_3 as select g2_2.src as g2src, g4dst from g2_2, g3_3 where g2_2.dst=g3src;
create or replace view res as select distinct g1_2.src, g4dst from g2_3, g1_2 where g1_2.dst=g2src;
select sum(src+g4dst) from res;
