...
create or replace view res as select c_name, c_custkey, o_orderkey, o_orderdate, o_totalprice, sum(l_sum) as agg from bag1_new, l_agg where o_orderkey = l_orderkey group by c_name, c_custkey, o_orderkey, o_orderdate, o_totalprice;
