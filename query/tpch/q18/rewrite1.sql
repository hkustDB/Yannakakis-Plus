drop view if exists aggView8332612307866309136 cascade;
drop view if exists aggView3925985072024311107 cascade;
drop view if exists aggView2753596546360130738 cascade;
drop view if exists aggJoin2701003659168497691 cascade;
drop view if exists aggView6658095675650738743 cascade;
drop view if exists aggJoin6206033633546833496 cascade;
drop view if exists aggView3903425438391363801 cascade;
drop view if exists aggJoin140228834879142929 cascade;
...
create or replace view aggView3903425438391363801 as select v1, v2 from aggView8332612307866309136;
create or replace view aggJoin140228834879142929 as select v12, v9, v1, v13, v35, v2 from aggJoin6206033633546833496 join aggView3903425438391363801 using(v1);
