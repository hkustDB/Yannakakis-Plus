...
create or replace view aggJoin7778781481622489446 as select v12, v9, v1, v13, v9 from aggView1471952055101280508 join aggView3664420267127271651 using(v9);
...
create or replace view aggJoin5398555787813874058 as select v12, v9, v1, v13, v9, v35, annot from aggJoin7778781481622489446 join aggView5521260041768851821 using(v9);
create or replace view aggView5005192139272233718 as select v1, v2 from aggView6739258701789052001 group by v1,v2;
create or replace view aggJoin4574344692891056136 as select v12, v9, v1, v13, v9, v35*aggView5005192139272233718.annot as v35, v2 from aggJoin5398555787813874058 join aggView5005192139272233718 using(v1);
