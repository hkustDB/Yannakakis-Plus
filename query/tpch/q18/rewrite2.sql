...
create or replace view aggJoin7874907223904028357 as select v12, v9, v1, v13, v9 from aggView6723948901473707578 join aggView3821583283115863852 using(v9);
...
create or replace view aggJoin2037632745669185196 as select v12, v9, v1, v13, v9, v35, annot from aggJoin7874907223904028357 join aggView418734586836044957 using(v9);
