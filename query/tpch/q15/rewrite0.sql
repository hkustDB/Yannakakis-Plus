...
create or replace view semiJoinView3087091906926738644 as select l_suppkey as v1, total_revenue as v9 from revenue0 AS revenue0 where (l_suppkey) in (select v1 from semiJoinView6374496634503462177);
...
select sum(distinct v1+v2+v3+v5+v9) from semiEnum8003310503106144034;
