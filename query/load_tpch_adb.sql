...
CREATE TABLE IF NOT EXISTS region ( 
  ...
  dummy varchar
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/region/';
...
CREATE TABLE IF NOT EXISTS part (
  ...
  dummy varchar
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/part/';
...
CREATE TABLE IF NOT EXISTS supplier (  
  ...
  dummy varchar
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/supplier/';
...
CREATE TABLE IF NOT EXISTS partsupp (  
  ...
  dummy varchar
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/partsupp/';
...
CREATE TABLE IF NOT EXISTS customer (  
  ...
  `dummy` varchar 
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/customer/';
...
CREATE TABLE IF NOT EXISTS orders (  
  ...
  dummy varchar
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/orders/';
...
CREATE TABLE IF NOT EXISTS lineitem ( 
  ...
  dummy varchar
) STORED AS `PARQUET` LOCATION 'oss://olap-qa-bj/tpch/parquet/100g/lineitem/';
