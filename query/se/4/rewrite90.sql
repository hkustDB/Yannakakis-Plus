create or replace view aggView5416604822714802839 as select id as v11, site_id as v1 from question as q1 where score<=1000 and score>=10;
...
create or replace view aggJoin2241072190509520912 as select id as v35, site_id as v1, upvotes as v8, account_id as v50, annot from so_user as u1, aggView6746247049134764014 where u1.site_id=aggView6746247049134764014.v1 and u1.id=aggView6746247049134764014.v35 and upvotes>=10 and upvotes<=1000000;
