...
create or replace view aggJoin6136926457949502087 as select site_id as v1, view_count as v23, owner_user_id as v25, annot from question as q1, aggView4874441235793626411 where q1.site_id=aggView4874441235793626411.v1 and q1.id=aggView4874441235793626411.v17 and view_count>=10 and view_count<=100000;
