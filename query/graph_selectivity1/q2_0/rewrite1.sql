...
create or replace view joinView5178584294044802749 as select v2, v12, oriRight, oriLeft from joinView7069601001599074295 join orderView512841384026446192 using(v12) where oriLeft-50<oriRight;
create or replace view end2743540660618172977 as select v12, v10, v2, v8, comp_right from joinView5178584294044802749 join bag191 using(v12) where oriLeft-50<comp_right;
create or replace view end2113906185786317813 as select v12, v10, v2, v8, v6, v4 from end2743540660618172977 join bag190 using(v2) where comp_left-50<comp_right;
