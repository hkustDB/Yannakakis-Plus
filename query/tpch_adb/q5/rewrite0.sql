...
create or replace view aggView5352480432310681933 as select v42, v49, v50, v4 from aggJoin5214191593480029363;
create or replace view aggJoin5794821157700753019 as select v42, v49 from aggView5352480432310681933 where v4 = v50;
select sum(v42), sum(v49) from aggJoin5794821157700753019;