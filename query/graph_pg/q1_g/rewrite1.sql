...
create or replace view g1 as select google.src as v1, google.dst as v2, v8 from google, (SELECT src, COUNT(*) AS v8 FROM google GROUP BY src) AS c1 where google.src = c1.src;
...
create or replace view joinView5287326421687254392 as select src as v2, dst as v4, mfL7155191615852546882 from google AS g2, minView2532017102651017099 where g2.src=minView2532017102651017099.v2;
