...
create or replace view sample6609443942425458862 as select * from orderView2490521377876743259 where rn % 10 = 1;
...
create or replace view sample5075383381613704189 as select * from orderView8862582456565459317 where rn % 10 = 1;
