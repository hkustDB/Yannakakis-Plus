...
drop view if exists orderView6620718935951558700 cascade;
drop view if exists minView1858307380708588028 cascade;
drop view if exists joinView3221132619229835891 cascade;
drop view if exists g3 cascade;
drop view if exists orderView465427837019590600 cascade;
drop view if exists minView5658894713236327862 cascade;
drop view if exists joinView5953594695163622277 cascade;
drop view if exists sample3834979675944423067 cascade;
drop view if exists maxRn2920803296303508886 cascade;
drop view if exists target4167348587806158776 cascade;
drop view if exists end4347110622918502558 cascade;
drop view if exists sample64194354303802702 cascade;
drop view if exists maxRn4290819751553636308 cascade;
drop view if exists target4057853648481464129 cascade;
drop view if exists end8970694911244070657 cascade;
...
select * from end8970694911244070657;
