...
DROP VIEW IF EXISTS semiJoinView7627369833810680766 CASCADE;
DROP VIEW IF EXISTS g3 CASCADE;
DROP VIEW IF EXISTS semiJoinView6077623104081581704 CASCADE;
DROP VIEW IF EXISTS semiEnum2569224710753344310 CASCADE;
DROP VIEW IF EXISTS semiEnum6682564033682477993 CASCADE;
...
/*+QUERY_TIMEOUT=86400000*/select sum(v2+v7+v6+v10+v8+v4) from semiEnum6682564033682477993;
