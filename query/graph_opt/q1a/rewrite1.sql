...
drop view if exists semiJoinView3909535377947813990 CASCADE;
drop view if exists g1 CASCADE;
drop view if exists semiJoinView430260019452849920 CASCADE;
drop view if exists semiEnum3589851949763290081 CASCADE;
drop view if exists semiEnum1200320528613366840 CASCADE;
...
/*+QUERY_TIMEOUT=86400000*/select sum(v2+v7+v6+v10+v8+v4) from semiEnum1200320528613366840;