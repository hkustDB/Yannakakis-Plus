...
create or replace view semiJoinView6213114770400706162 as select src as v2, dst as v4 from google AS g2, g5_proj where g2.dst = v4;
...
create or replace view res as select distinct v2, v4 from semiJoinView8500852560655297705 join g3_proj using (v4);
