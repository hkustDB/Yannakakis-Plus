...
DROP VIEW IF EXISTS g2 CASCADE;
DROP VIEW IF EXISTS semiJoinView444966550382830414 CASCADE;
DROP VIEW IF EXISTS g3 CASCADE;
DROP VIEW IF EXISTS semiJoinView3490531790439417022 CASCADE;
DROP VIEW IF EXISTS semiEnum8393246556235228363 CASCADE;
DROP VIEW IF EXISTS semiEnum30757211987272603 CASCADE;
...
create or replace view semiJoinView444966550382830414 as select v2, v4, v12 from g2 where (v2) in (select v2 from g1);
...
/*+QUERY_TIMEOUT=86400000*/select sum(v2+v10+v9+v4+v14+v8+v12+v7) from semiEnum30757211987272603;
