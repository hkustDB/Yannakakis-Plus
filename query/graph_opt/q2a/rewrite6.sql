...
DROP VIEW IF EXISTS bag146 CASCADE;
DROP VIEW IF EXISTS semiJoinView405405512828912179 CASCADE;
DROP VIEW IF EXISTS bag147 CASCADE;
DROP VIEW IF EXISTS semiJoinView3373194824686483720 CASCADE;
DROP VIEW IF EXISTS semiJoinView7272165093693344488 CASCADE;
DROP VIEW IF EXISTS semiJoinView5406759702447789712 CASCADE;
DROP VIEW IF EXISTS semiEnum1828986716496813122 CASCADE;
DROP VIEW IF EXISTS semiEnum615008803790650463 CASCADE;
DROP VIEW IF EXISTS semiEnum7447080251055185610 CASCADE;
DROP VIEW IF EXISTS semiEnum6333953542175638490 CASCADE;
...
/*+QUERY_TIMEOUT=86400000*/select sum(v6+v21+v8+v9+v3+v18+v5+v11+v14+v15+v12+v17+v2) from semiEnum6333953542175638490;
