...
DROP VIEW IF EXISTS bag160 CASCADE;
DROP VIEW IF EXISTS semiJoinView6185501572136432982 CASCADE;
DROP VIEW IF EXISTS bag161 CASCADE;
DROP VIEW IF EXISTS semiJoinView6187694488517957174 CASCADE;
DROP VIEW IF EXISTS semiJoinView4979689585304852856 CASCADE;
DROP VIEW IF EXISTS semiJoinView5126476360739360105 CASCADE;
DROP VIEW IF EXISTS semiEnum6778309047584163251 CASCADE;
DROP VIEW IF EXISTS semiEnum701336989506807767 CASCADE;
DROP VIEW IF EXISTS semiEnum3921252799521482609 CASCADE;
DROP VIEW IF EXISTS semiEnum4940697859984591171 CASCADE;
...
/*+QUERY_TIMEOUT=86400000*/select sum(v6+v21+v8+v9+v3+v18+v5+v11+v14+v15+v12+v17+v2) from semiEnum4940697859984591171;
