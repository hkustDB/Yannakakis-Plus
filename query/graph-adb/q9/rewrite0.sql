create or replace view aggView4175807585068549620 as select src as v6, SUM(dst) as v11, COUNT(*) as annot from Graph as g4 group by src,dst;
...
create or replace view aggView7179948322801388916 as select dst as v2, SUM(src) as v12, COUNT(*) as annot from Graph as g1 group by dst,src;
