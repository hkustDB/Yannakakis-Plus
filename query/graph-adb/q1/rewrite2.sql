...
create or replace view res as select v1, v8, v4, v6, v2, v10 from end9143353758902039175 join target5589324323816749532 using(v4) where v8<v10;
select sum(v1 + v8 + v4 + v6 + v2 + v10) from res;