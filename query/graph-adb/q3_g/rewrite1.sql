...
create or replace view sample2213805785759978902 as select * from orderView8395628036832074863 where rn % 100 = 1;
...
create or replace view sample2192164103222857216 as select * from orderView6441979147187950152 where rn % 100 = 1;
...
/*+QUERY_TIMEOUT=86400000*/select sum(v2+v4+v7+v8+v9+v10+v12+v14) from end6018174537634284604;
